<div class="post link github">
<h3>
<a href="https://github.com/shakabra/aloha-file-server">
aloha server</a>
</h3>
</div>
<script>
jQuery(document).ready(function($){
  ...
  $.each($('h3 a'), function() {
    ...
    $.getJSON("https://api.github.com/shakabra/aloha-file-server?callback=?", function(data){
